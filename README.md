...
- PHP 5.3, 5.4, 5.5, 5.6, 7.0, 7.1, 7.2, 7.3, 7.4, 8.0, 8.1, 8.2, 8.3, 8.4 14가지 버전을 지원하며, 하나의 서버에서 2개 이상의 PHP 사용 가능.
  ...
  - Rocky Linux 9) PHP 7.4 이상 지원. (PHP 7.3 이하는 OpenSSL 3 호환 불가로 지원불가) 
- Laravel 5.1~5.5, WordPress, XE, Rymix, 그누보드 4/5, phpMyAdmin 자동 설치 지원.  ([app-install.sh](app-install.sh))
...
> CentOS 6/7, Rocky Linux 8/9 만 지원됩니다.  (minimal 설치 환경 지원)
...
## 방화벽 설정 안내
- CentOS 7, Rocky Linux 8/9 + firewalld 설정: https://github.com/php79/stack/wiki/firewall
